...
c     
      real xta,yta,xua,yua,zwa,zta
      real dxtdega, dytdega, dzta
      real dxudega, dyudega, dzwa

      common /coorda/ xta(0:imta,0:jmta+1),yta(0:imta,0:jmta+1),
     & xua(0:imta,0:jmta),yua(0:imta,0:jmta),
     &               zwa(km),zta(km)
      common /coorda/ dxtdega(imta,jmta),dytdega(imta,jmta),dzta(km)
      common /coorda/ dxudega(imta,jmta),dyudega(imta,jmta),dzwa(0:km)
